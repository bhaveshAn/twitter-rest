...
class ProfileSerializerOut(serializers.ModelSerializer): #Serializer for when data needs for GET purposes
...
class UserSerializerOut(serializers.ModelSerializer): #Serializer for when data needs for GET purposes
    ...
    class Meta:
        model = CustomUser
        fields = ('id', 'first_name', 'last_name', 'replies',
...
class UserSerializerCreate(serializers.ModelSerializer):    #Serializer for creating an account
    ...
    def create(self, validated_data):
        user = CustomUser.objects.create_user(**validated_data) #When being created, call create user function
        return user
