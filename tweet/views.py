...
from tweet.serializers import TweetReadSerializer, TweetMakeSerializer, ReplyTweetSerializerCreate
...
class TweetDetail(generics.RetrieveAPIView): #Generic class based view to show specific user
    queryset = Tweet.objects.all()
